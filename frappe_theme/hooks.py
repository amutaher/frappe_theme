...
app_include_js = [
    f"/assets/frappe_theme/js/filter_area.js?ver={time.time()}",
    f"/assets/frappe_theme/js/filter_list.js?ver={time.time()}",
    f"/assets/frappe_theme/js/filter.js?ver={time.time()}",
    f"/assets/frappe_theme/js/field_select.js?ver={time.time()}",
